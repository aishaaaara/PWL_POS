    ...
    public function list(Request $request)
{
    ...
    {
        $request->validate([
            // kategori_kode harus diisi, berupa string, dan bernilai unik di tabel m_kategori kolom kategori_kode
            'kategori_kode' => 'required|string|unique:m_kategori,kategori_kode',
            
            // kategori_nama harus diisi, berupa string, dan maksimal 100 karakter
    ...
    {
        $request->validate([
            // kategori_kode harus diisi, berupa string, dan bernilai unik di tabel m_kategori kecuali untuk kategori dengan id yang sedang diedit
